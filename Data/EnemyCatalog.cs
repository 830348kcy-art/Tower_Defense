...
public static class EnemyCatalog
{
    public static readonly Dictionary<EnemyKind, EnemyDef> Enemies = new()
    {
        ...
        { EnemyKind.Elite, new EnemyDef
        {
            ...
            GoldReward = 60, ColorHex = "#64748B", Radius = 19, LivesCost = 2
        }},
        { EnemyKind.EliteCharge, new EnemyDef
        {
            ...
            GoldReward = 48, ColorHex = "#F97316", Radius = 19, LivesCost = 2,
        ...
        { EnemyKind.EliteRegenerator, new EnemyDef
        {
            ...
            GoldReward = 64, ColorHex = "#16A34A", Radius = 18, LivesCost = 2,
        ...
        { EnemyKind.EliteWyvern, new EnemyDef
        {
            ...
            GoldReward = 56, ColorHex = "#A78BFA", Radius = 18, LivesCost = 2
        }},
        { EnemyKind.MidBossNormal, new EnemyDef
        {
            ...
            GoldReward = 200, ColorHex = "#D84315", Radius = 26, LivesCost = 5, IsMidBoss = true
        }},
        { EnemyKind.MidBossCharge, new EnemyDef
        {
            ...
            GoldReward = 220, ColorHex = "#EA580C", Radius = 26, LivesCost = 5, IsMidBoss = true,
        ...
        { EnemyKind.MidBossSplit, new EnemyDef
        {
            ...
            GoldReward = 240, ColorHex = "#F97316", Radius = 27, LivesCost = 5, IsMidBoss = true,
        ...
        { EnemyKind.MidBossSpeed, new EnemyDef
        {
            ...
            GoldReward = 220, ColorHex = "#0284C7", Radius = 25, LivesCost = 5, IsMidBoss = true,
        ...
        { EnemyKind.BossNormal, new EnemyDef
        {
            ...
            GoldReward = 520, ColorHex = "#4A148C", Radius = 35, LivesCost = 10, IsBoss = true
        }},
        { EnemyKind.BossCharge, new EnemyDef
        {
            ...
            GoldReward = 560, ColorHex = "#B45309", Radius = 35, LivesCost = 10, IsBoss = true,
        ...
        { EnemyKind.BossSplit, new EnemyDef
        {
            ...
            GoldReward = 600, ColorHex = "#DC2626", Radius = 36, LivesCost = 10, IsBoss = true,
        ...
        { EnemyKind.BossSpeed, new EnemyDef
        {
            ...
            GoldReward = 560, ColorHex = "#0369A1", Radius = 34, LivesCost = 10, IsBoss = true,
